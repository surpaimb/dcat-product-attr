(function () {
    function SKU(wrap) {
        this.wrap = $(wrap);
        this.attrs = {};
        this.productAttributes = JSON.parse($('.product_attributes').val());
    ...
    SKU.prototype.init = function () {
        ...
        _this.wrap.find('.sku_attr_key_val').on('change', '.attribute_selector', function () {
            if ($(this).val() != 'input') {
                let productAttributesArray = _this.productAttributes;
                _this.attrIndex = $(this).find("option:selected").data('idx');
                _this.skuAttr = productAttributesArray[_this.attrIndex];
            }
        ...
        if (old_val) {
            ...
            attr_keys.forEach(function (attr_key, index) {
                ...
                let scopeAttrType = '';
                let sku = _this.productAttributes.filter((res) => {
    ...
    SKU.prototype.getHtml = function (innerHtml = '') {
        let _this = this;
        let productAttributesArray = this.productAttributes;
        ...
        productAttributesArray.forEach(function (v, i) {
    ...
    window.SurpaimbProductAttribute = SKU;
})();
