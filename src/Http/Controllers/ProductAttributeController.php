...
namespace Dcat\Admin\Extension\DcatProductAttr\Http\Controllers;

use Dcat\Admin\Extension\DcatProductAttr\Http\Repositories\ProductAttribute;
use Dcat\Admin\Form;
use Dcat\Admin\Grid;
...
class ProductAttributeController extends AdminController
{
    ...
    {
        return Form::make(new ProductAttribute(), function (Form $form) {
            $form->display('id');
